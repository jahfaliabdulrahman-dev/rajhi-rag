...
ملفَّ المعرّفات بدل الاعتماد على ملفٍّ محلّيّ) ⇒ **النسخةُ النقيّة عند ذلك القياس: `616 passed · 55 skipped · 0 failed`**
(**وهو رقمٌ مؤرَّخ بزمنه**: أُعيد 2026-09-26 على `c268a44` ⇒ **٧٩٩ · ٥٨ · ٠** — والرسالةُ تُترك بزمنها، والعدّادُ الحيّ في `docs/QA_CHECKLIST.md`).

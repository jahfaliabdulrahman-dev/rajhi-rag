...
PARSED = {"debits": "9001.00", "credits": "9001.00", "balance": "9001.00"}
...
def test_a_single_field_difference_is_named_not_swallowed():
    ...
    assert cell["ours"] == "9001.00" and cell["oracle"] == "5647.00"
...
def test_arabic_printed_digits_compare_equal_to_latin_parsed_ones():
    ...
    arabic = {"debits": "9001.00", "credits": "9001.00", "balance": "9001.00"}

"""ترقيمُ **عناوين** قواعد البروتوكول: لا رقمَ يحمل عنوانَين، وكلُّ إحالةٍ في `tools/` و`tests/` تُحلّ
إلى عنوانٍ موجود، وأداةُ المراجعة ممثَّلةٌ في المستودع (القاعدةُ الحديديّة ٦).

**وحدُّه المُعلَن — مؤجَّل، ويُقاس بالعنوان لا بالقائمة:** بنودُ قائمة §٦ مُرقَّمة ١–١٧ بعيداً عن
العناوين ١٢–٢٢ ⇒ ستّةُ أرقامٍ (١٢ · ١٣ · ١٤ · ١٥ · ١٦ · ١٧) تحمل معنيَين مختلفين بين السلسلتين
(مثال: ١٢ = «الأبناءُ لا يرثون بيئةَ الأب» في القائمة، و= «لا يُعفى موضع، يُعفى قيمة» في العنوان).
فالتوحيدُ دفعةُ توثيقٍ قائمةٌ بذاتها (مقعدُ المعايير، مراجعة ٤١/٢)، **وهذا الاختبارُ يحرس العناوين
وحدَها** — ولا يدّعي سلسلةً واحدة.

...
#: **ورُفع إلى ٦٤ يومَ 2026-09-25 بقرارٍ مُعلن**: دفعُ صندوق المدقّق (٧ مراجعات) أضاف سطراً واحداً —
#: مسارُ أرشيفٍ يحمل بصمةَ محتوى في اسمه (`eval-runs/20260924-<hash>/`). ولم أُوسّع الاستثناء: مسارٌ يحمل
#: معرّفاً قد يكون إحالةً حقيقية (`repo/commit/<id>`)، فالقرارُ رفعُ السقف لا إضعافُ الصيغة.
FOREIGN_ID_DEBT_ON_CORPUS = 64

...
#: يُبدّلها في الوثيقة والضابط أيضًا، وإلّا **سقط الضابطُ في الـCI**: `tests/test_parser.py` مُدرَجٌ في
#: قائمة الـCI المُعلَنة في `docs/GATES.md`، ويقابل الاتجاهين `tests/test_gate_registry.py` تساويًا.

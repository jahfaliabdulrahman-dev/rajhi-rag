...
#: العربيّ حرفَ كلمة ⇒ **«الـsha <معرّف>»** — وهي لغةُ هذا المستودع نفسِه (**١١ سطراً في ٤ ملفّات**، منها
...
#: **و R58-1 (مراجعة ٥٨):** الرقمُ أعلاه مقامُه «الشجرةُ المُتتبَّعة **بلا `handoff/`**» — صندوقُ المراسلة ليس
#: كوربوسَ المنفّذ، ولو عُدّ لصار إنزالُ مراجعةٍ تقتبس الصيغة **إسقاطاً** لبوّابةٍ لا يملك المدقّقُ تعديلَها.

...
#: العربيّ حرفَ كلمة ⇒ **«الـsha <معرّف>»** — وهي لغةُ هذا المستودع نفسِه (٢٧ سطراً في ١٦ ملفّاً، منها
#: البروتوكول §٥) — **لا تُكشَف**، وكانت تُكشَف قبل الإصلاح. ⇒ الحدُّ صار **لاتينيّ الطرفين** لا `\b`:
